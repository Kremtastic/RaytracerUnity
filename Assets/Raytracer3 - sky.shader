Shader "Unlit/BlueToWhiteGradient"
{
    Properties
    {
    ...
    SubShader
    {
	    ...
	    CGPROGRAM
            ...
            fixed4 frag(v2f i) : SV_Target
            {
                ...
                float3 lower_left_corner = float3(-2, -1, -1);
                float3 horizontal = float3(4, 0, 0);
                float3 vertical = float3(0, 2, 0);
                float3 direction = lower_left_corner + i.uv.x*horizontal + i.uv.y*vertical - origin;
