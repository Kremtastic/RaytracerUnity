...
////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	{
		float x = i.uv.x; // Horizontal position, from 0 (left) to 1 (right)
		float y = i.uv.y; // Vertical position, from 0 (bottom) to 1 (top)
    
		col3 col;
    
		// Implement the C# logic for red and green based on the pixel positions
		col.x = x; // Red increases from left to right, directly mapped from the horizontal position
		col.y = 1.0 - y; // Green increases from top to bottom, so we invert the vertical position
    
		// Blue component is set to 0 as per the C# function logic
		col.z = 0;
